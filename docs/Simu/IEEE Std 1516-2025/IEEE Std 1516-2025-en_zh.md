...
美国纽约州纽约市公园大道3号，邮编10016-5997

版权所有 © 2025 电气与电子工程师协会
2025年5月14日出版。美国印刷。

IEEE是美国专利商标局注册的商标，由电气与电子工程师协会所有。

PDF: ISBN 979-8-8557-2084-6 STD27841
印刷版: ISBN 979-8-8557-2085-3 STDPD27841

IEEE禁止歧视、骚扰和欺凌。
欲了解更多信息，请访问 https://www.ieee.org/about/corporate/governance/p9-26.html。
未经出版商事先书面许可，不得以任何形式或电子检索系统复制本出版物的任何部分。

## 关于IEEE标准文件的重要声明与免责声明

IEEE标准文件供您使用，但需遵守重要的声明和法律免责声明。这些声明和免责声明，或对本页面（https://standards.ieee.org/ipr/disclaimers.html）的引用，出现在所有IEEE标准中，可在该标题下找到："关于IEEE标准文件的重要声明与免责声明"。

## 关于使用IEEE标准文件的责任声明与免责声明

IEEE标准文件由IEEE标准协会（IEEE SA）理事会下属的IEEE各专业委员会和小组委员会制定。IEEE通过认证的共识开发流程制定其标准，该流程汇集了代表不同观点和利益的志愿者，以最终产品。IEEE标准是由具有技术工作组中科学、学术和行业专业知识背景的志愿者制定的文件。技术工作组的志愿者不一定是IEEE或IEEE SA的成员，且在无补偿的情况下参与。IEEE虽然管理流程并制定规则以促进共识开发过程的公平性，但不独立评估、测试或验证任何信息的准确性或其标准中任何判断的合理性。

IEEE对其标准不做任何保证或声明，并明确拒绝承担对所有标准的所有保证，包括但不限于对适销性、特定目的适用性和不侵权的保证。IEEE标准文件不保证安全、安保、健康或环境保护，或法律合规性，也不保证免受来自其他设备或网络的干扰或免受其影响。此外，IEEE不保证或声明其标准中包含的材料的使用不会侵犯专利。IEEE标准文件按"原样"和"带所有故障"提供。

使用IEEE标准完全是自愿的。IEEE标准的存在并不意味着没有其他方式来生产、测试、测量、购买、营销或提供与IEEE标准范围相关的其他商品和服务。此外，标准获得批准和发布时表达的观点可能会因技术发展状态和标准用户收到的意见而发生变化。

在发布和提供其标准时，IEEE并非暗示或提供任何个人或实体的专业或其他服务，也并非代表任何个人或实体承担任何职责。使用任何IEEE标准文件的人员应在任何给定情况下依靠自己的独立判断行使合理注意义务，或酌情寻求合格专业人员的建议，以确定特定IEEE标准的适当性。

> 在任何情况下，IEEE均不对任何直接、间接、附带、特殊、示例性或后果性损害（包括但不限于：需要采购替代商品或服务的损害；数据或利润的使用损失；或业务中断）负责，无论损害如何造成以及基于任何责任理论（无论是合同、严格责任还是侵权（包括疏忽或其他）），均不因出版、使用或依赖任何标准而承担任何责任，即使已告知可能发生此类损害的可能性，且无论此类损害是否可预见。
