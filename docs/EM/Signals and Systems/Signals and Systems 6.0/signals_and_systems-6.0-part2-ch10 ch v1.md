...
示例 10.8. 示例 10.4 中的 8 周期序列 $x$ 的傅里叶级数系数序列 $c$ 为：
...
$$
\begin{aligned}
\arg c_{k} & =\arg \left(\frac{\sin \left(\frac{\pi}{2} k\right)}{8 e^{j(3 \pi / 8) k} \sin \left(\frac{\pi}{8} k\right)}\right) \\
...
$$
\begin{aligned}
b_{-1} & =a_{-1} H\left(-\frac{\pi}{2}\right)=\frac{1}{4} \cdot \frac{1}{2-j} = \frac{1}{4 \sqrt{5}} e^{j \pi / 4}, \\
b_{0} & =a_{0} H(0)=1, \\
b_{1} & =a_{1} H\left(\frac{\pi}{2}\right)=\frac{1}{4} \cdot \frac{1}{2+j} = \frac{1}{4 \sqrt{5}} e^{-j \pi / 4}, \\
b_{2} & =a_{2} H(\pi)=\frac{1}{8} \cdot \frac{1}{3} = \frac{1}{24}.
\end{aligned}
$$
...
$$
\begin{aligned}
y(n) & =\sum_{k=-1}^{2} b_{k} e^{j(2 \pi / 4) k n} \\
& =b_{-1} e^{-j(\pi / 2) n}+b_{0}+b_{1} e^{j(\pi / 2) n}+b_{2} e^{j \pi n} \\
...
$$
\begin{aligned}
H(\Omega) & =\frac{1}{2}\frac{1}{1-\frac{1}{2}(\cos \Omega - j \sin \Omega)} \\
...
$$
\begin{aligned}
y(n) & =\sum_{k=-2}^{2} c_{k} H\left(\frac{2 \pi}{5} k\right) e^{j(2 \pi /5) k n} \\
