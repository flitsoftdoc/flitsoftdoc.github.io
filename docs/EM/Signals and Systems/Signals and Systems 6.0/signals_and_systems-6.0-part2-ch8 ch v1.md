...
$$
\begin{aligned}
\mathcal{H} x\left(n-n_{0}\right) & =\sin \left[x\left(n-n_{0}\right)\right], \\
\mathcal{H} x^{\prime}(n) & =\sin \left[x^{\prime}(n)\right] = \sin \left[x\left(n-n_{0}\right)\right].
\end{aligned}
$$
...
$$
\begin{aligned}
\mathcal{H} x\left(n-n_{0}\right) & =\left(n-n_{0}\right) x\left(n-n_{0}\right), \\
\mathcal{H} x^{\prime}(n) & =n x^{\prime}(n) = n x\left(n-n_{0}\right).
\end{aligned}
$$
...
$$
\begin{aligned}
\mathcal{H} x\left(n-n_{0}\right) & =\sum_{k=-10}^{10} k x\left(n-n_{0}-k\right), \\
\mathcal{H} x^{\prime}(n) & =\sum_{k=-10}^{10} k x^{\prime}(n-k) = \sum_{k=-10}^{10} k x\left(n-k-n_{0}\right) = \sum_{k=-10}^{10} k x\left(n-n_{0}-k\right).
\end{aligned}
$$
...
$$
\begin{aligned}
\mathcal{H} x\left(n-n_{0}\right) & =\frac{1}{2}\left[x\left(n-n_{0}\right)-x\left(-\left(n-n_{0}\right)\right)\right] = \frac{1}{2}\left[x\left(n-n_{0}\right)-x\left(-n+n_{0}\right)\right], \\
\mathcal{H} x^{\prime}(n) & =\frac{1}{2}\left[x^{\prime}(n)-x^{\prime}(-n)\right] = \frac{1}{2}\left[x\left(n-n_{0}\right)-x\left(-n-n_{0}\right)\right].
\end{aligned}
$$
