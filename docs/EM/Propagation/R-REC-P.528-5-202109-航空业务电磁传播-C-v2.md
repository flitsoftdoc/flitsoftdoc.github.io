...
ITU－R的IPR政策述于ITU－R第1号决议中所参引的《ITU－T／ITU－R／ISO／IEC的通用专利政策》。专利持有人用于提交专利声明和许可声明的表格可从http：／／www．itu．int／ITU－R／go／patents／zh获得，在此处也可获取《ITU－ T／ITU－R／ISO／IEC的通用专利政策实施指南》和ITU－R专利信息数据库。
...
# ITU－R P．528－5建议书＊ ＊＊ <br> 使用VHF、UHF和SHF频段的航空移动和 <br> 无线电导航业务的传播预测方法 
...
> ${ }^{*}$ 应提请第5研究组注意本建议书。
> ${ }^{**}$ 无线电通信第3研究组根据ITU-R第1号决议于2022年对该建议书进行了编辑性修正。
