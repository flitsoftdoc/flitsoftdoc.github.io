...
0 \\
i \times d
\end{array}\right] \quad \text { 或 } \quad \Delta_i=\left[\begin{array}{c}
i \times d_x \\
i \times d_y
\end{array}\right],
$$
...
$$
\Delta_{i, \text { 左 }}=\left[\begin{array}{c}
i d_x \\
i d_y
\end{array}\right], \quad \Delta_{i, \text { 右 }}=\left[\begin{array}{c}
i d_x \\
-i d_y
